...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAC] = LAYOUT(
     ...
     KC_NO, MT(MOD_LGUI, KC_C), MT(MOD_LALT, KC_R), MT(MOD_LCTL, KC_S), MT(MOD_LSFT, KC_T), KC_G,                               KC_M, MT(MOD_LSFT, KC_N), MT(MOD_LCTL, KC_E), MT(MOD_LALT, KC_I), MT(MOD_LGUI, KC_A), KC_NO,
     KC_NO, KC_Q,           KC_J,           KC_V,            KC_D,           KC_K, KC_NO,   KC_NO,               KC_X, KC_H,           KC_COMM,        KC_DOT,         KC_SLSH,        KC_NO,
                                                           KC_NO, KC_ESC, KC_SPC, KC_TAB,   LT(_MACSYM, KC_ENT), KC_BSPC,  KC_MINS, KC_NO
    ),
    [_MACSYM] = LAYOUT(
     KC_NO,   KC_EXLM, KC_AMPR, KC_LCBR, KC_RCBR, KC_CIRC,                                             G(S(KC_4)),   KC_7,   KC_8, KC_9, KC_COLN, KC_NO,
     KC_NO,   KC_EQL,  KC_DLR,  KC_LPRN, KC_RPRN, KC_TILD,                                             C(KC_UP),        KC_4,   KC_5, KC_6, KC_PLUS, KC_NO,
     KC_NO,   KC_AT,   KC_PERC, KC_LBRC, KC_RBRC, KC_UP,   XXXXXXX,                           XXXXXXX, KC_0,         KC_1,   KC_2, KC_3, KC_BSLS, KC_NO,
