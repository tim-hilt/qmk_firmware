...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
     ...
     KC_LSFT,         KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_NO  ,                                   KC_NO,              KC_K,     KC_H,      KC_COMM, KC_DOT,  KC_SLSH, KC_END,
                                                 KC_NO,   KC_LALT, KC_SPC, KC_LGUI,        LT(_SYM, KC_ENT),  LSFT_T(KC_BSPC),    MO(_INT), KC_NO
    ),
    [_SYM] = LAYOUT(
     MC_GRV,  KC_EXLM, KC_AMPR, KC_LCBR, KC_RCBR, MC_CIRC,                                         G(S(KC_S)),   KC_7,   KC_8, KC_9, KC_COLN, KC_TRNS,
